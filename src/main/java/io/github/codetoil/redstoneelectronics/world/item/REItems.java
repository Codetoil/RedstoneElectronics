...
public class REItems {
    ...
    public static final RegistryObject<Item> MOTOR_BLOCK_ITEM = RE_ITEMS.register("redstone_motor", () -> new BlockItem(REBlocks.MOTOR_BLOCK.get(), new Item.Properties().tab(CreativeModeTab.TAB_REDSTONE)));
